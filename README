...
pages and, if Page Forms is installed, form pages. The XML can be created
and edited via a helper form, preventing users from having to generate or
modify it manually.
...
This version of the Page Schemas extension requires MediaWiki 1.33 or
higher.
...
Page Schemas was initially created by Ankit Garg as part of the 2011
Google Summer of Code program. It was then modified substantially by
Yaron Koren, who also mentored the Google Summer of Code project.

Section handling was added by Himeshi De Silva as part of the 2013
Google Summer of Code, again mentored by Yaron.
...
Page Schemas includes the SortableJS JavaScript library
(https://sortablejs.github.io/Sortable/) by RubaXa and owenm,
